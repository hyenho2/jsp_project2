    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="img/anime/mon.jpg">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            </div>   <p>문복희 Eat with Boki라는 이름으로 유튜브에서 활동하고 있는 대한민국의 유튜버.
                            주로 먹방이나 먹방 중 ASMR 컨텐츠를 주로 업로드하고 있다.</p>
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                        	<li><span>플랫폼:</span> youtube</li>
                                            <li><span>구독자:</span> 922만명</li>
                                            <li><span>가입일:</span> 2019-04-09</li>
                                            <li><span>총 조회수:</span> 2,618,751,675</li>
                            ...
                            <div class="anime__details__btn">
                               <a href="anime-watching3.jsp" class="follow-btn"><i class="fa fa-heart-o"></i> 영상시청</a>
                                <a href="https://www.youtube.com/watch?v=IKEAbxRHL94" class="watch-btn" target="_blank"><span> 채널바로가기</span> <i
