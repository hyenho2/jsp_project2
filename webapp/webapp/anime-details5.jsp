    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="img/anime/lee.jpg">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <p>대한민국의 인터넷 방송인. 現 아프리카TV BJ, 유튜버주 컨텐츠는 게임이며, 
                            리그 오브 레전드, 피파 온라인, 스타크래프트 등 다양한 게임을 한다. 
                            특히 리그 오브 레전드를 오랫동안 하면서 많은 컨텐츠를 했고, 대회 참가나 주최, 해설 경험이 많다.</p>
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                        	<li><span>플랫폼:</span> youtube</li>
                                            <li><span>구독자:</span> 74만명</li>
                                            <li><span>가입일:</span> 2015-06-03</li>
                                            <li><span>총 조회수:</span> 435,789,433</li>
                            ...
                            <div class="anime__details__btn">
                               <a href="anime-watching5.jsp" class="follow-btn"><i class="fa fa-heart-o"></i> 영상시청</a>
                                <a href="https://www.youtube.com/watch?v=1XiVJQtWS6Q" class="watch-btn" target="_blank"><span> 채널바로가기</span> <i
