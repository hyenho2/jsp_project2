    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="img/anime/zzang.jpg">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <p>대한민국의 먹방 전문 인터넷 방송인. 
                            먹는 음식의 양이 많으면서도 살이 찌지 않는 체질로 유명하다. 
                            유튜브에서 눈에 띄게 성장세를 기록하면서 지상파 방송에도 출연하며 활약하고 있다.</p>
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                        	<li><span>플랫폼:</span> youtube</li>
                                            <li><span>구독자:</span> 871만명</li>
                                            <li><span>가입일:</span> 2018-11-20</li>
                                            <li><span>총 조회수:</span> 2,094,987,404</li>
                            ...
                            <div class="anime__details__btn">
                                <a href="anime-watching.jsp" class="follow-btn"><i class="fa fa-heart-o"></i> 영상시청</a>
                                <a href="https://www.youtube.com/@tzuyang6145" class="watch-btn" target="_blank"><span> 채널바로가기</span> <i
