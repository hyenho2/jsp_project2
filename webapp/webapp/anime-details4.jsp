    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="img/anime/DDDD.jpg">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <p>前 오버워치 프로게이머이자 현 인터넷 방송인이다.
                               풀네임은 뜨뜨뜨뜨라고 하지만 줄여서 뜨뜨 또는 뜨4 등으로 불린다.</p>
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                        	<li><span>플랫폼:</span> youtube</li>
                                            <li><span>구독자:</span> 156만명</li>
                                            <li><span>가입일:</span> 2016-11-29</li>
                                            <li><span>총 조회수:</span> 877,418,289</li>
                            ...
                            <div class="anime__details__btn">
                               <a href="anime-watching4.jsp" class="follow-btn"><i class="fa fa-heart-o"></i> 영상시청</a>
                                <a href="https://www.youtube.com/watch?v=YF3D_gWlv_Q" class="watch-btn" target="_blank"><span> 채널바로가기</span> <i
