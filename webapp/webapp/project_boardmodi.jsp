...
<!-- í¤ë ë¤ë¹ê²ì´ì -->
	...
	<div class="container">
		...
		<div class="row">
			...
			<form method="post" action="modiAction.jsp?bbsID=<%= bbsID%>">
				...
				<table class="table table-striped"
					...
					<tbody>
						...
						<tr>
							<th>내용</th>
							<td><input class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 350px;" value = "<%= bbs.getBbsContent() %>"
							></input></td>
