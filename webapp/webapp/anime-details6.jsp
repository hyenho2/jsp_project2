    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="img/anime/kim.jpg">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <p>대한민국의 前 서든어택 프로게이머. 現 아프리카TV BJ. 現 유튜버.
							BJ명은 항상#킴성태이며 배틀그라운드를 주로 하고있다. 
							BJ로 활동하기 이전에는 서든어택 프로게이머로 활동했으며, 
							오버워치가 출시되고 서든어택 프로게이머를 그만두고 본격적인 인터넷 방송인의 길을 걷게 되었다.</p>
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                        	<li><span>플랫폼:</span> youtube</li>
                                            <li><span>구독자:</span> 98만명</li>
                                            <li><span>가입일:</span> 2013-06-19</li>
                                            <li><span>총 조회수:</span> 859,356,100</li>
                            ...
                            <div class="anime__details__btn">
                               <a href="anime-watching6.jsp" class="follow-btn"><i class="fa fa-heart-o"></i> 영상시청</a>
                                <a href="https://www.youtube.com/watch?v=RhavXfQyGVU" class="watch-btn" target="_blank"><span> 채널바로가기</span> <i
